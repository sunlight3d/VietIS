...
public class UserRepository {
    ...
    public static final String URL_GET_DETAIL_USER =
            "http://"+Configurations.HOST_NAME+":"+Configurations.PORT+"/users/getDetailUser";
    ...
    public void getDetailUser(String tokenKey) {
        OkHttpClient okHttpClient = new OkHttpClient();
        RequestBody requestBody = new MultipartBody.Builder()
                .setType(MultipartBody.FORM)
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                try {
                    ...
                    JSONObject jsonUserObject = jsonObject.getJSONObject("data");
                    User user = User.createUserFromJSonObject(jsonUserObject);
                    iUserRepository.afterGetDetailUser(user, null);
                }catch (JSONException jsonException){
                    iUserRepository.afterGetDetailUser(null, jsonException);
                }
            }
            @Override
            public void onFailure(@NotNull Call call, @NotNull IOException ioException) {
