...
public class Book {
    ...
    */
    ...
    public static ArrayList<Book> generateFakeBooks() {
        ...
        books.add(new Book(1,"https://www.scotsman.com/images-e.jpimedia.uk/imagefetch/http://www.scotsman.com/webimage/Prestige.Item.1.74151213!image/image.jpg?crop=982:524,smart&width=990",
