...
rm -rf /root/deploy-17-08-2026/src
rm -rf /root/deploy-17-08-2026/prisma
rm -rf /root/deploy-17-08-2026/public

cd /root
tar -xzf deploy.tar.gz
cp -a KhoaHocViberCoding10buoi/17-08-2026/. deploy-17-08-2026/
